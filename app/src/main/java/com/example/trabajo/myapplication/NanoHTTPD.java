...
// Modified by tana_ash (@tana_ash, http://d.hatena.ne.jp/tana-ash/ )
// 警告が出ないようにコードを少しだけ修正 line 609, 833, 1049
// chunkedに対応させる
		...
		**/
		...
		private void sendResponse( String status, String mime, Properties header, InputStream data )
		{
          ...
          while (true)
            ...
            if (pending == 0) pending = 1;  // やっつけ data.readの3つめの引数が0の時はいつも戻り値が0になるらしい
